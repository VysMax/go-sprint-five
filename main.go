...
func (t Training) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	message := InfoMessage{TrainingType: t.TrainingType, Duration: t.Duration, Distance: t.distance(), Speed: t.meanSpeed(), Calories: t.Calories()}
	return message
}
...
func (r Running) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	message := InfoMessage{TrainingType: r.TrainingType, Duration: r.Duration, Distance: r.distance(), Speed: r.meanSpeed(), Calories: r.Calories()}
	return message
}
...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	return (CaloriesWeightMultiplier*w.Weight + (math.Pow(float64(w.meanSpeed())*KmHInMsec, 2)/(w.Height/CmInM))*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours
}
...
func (w Walking) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	message := InfoMessage{TrainingType: w.TrainingType, Duration: w.Duration, Distance: w.distance(), Speed: w.meanSpeed(), Calories: w.Calories()}
	return message
}
...
func (s Swimming) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	message := InfoMessage{TrainingType: s.TrainingType, Duration: s.Duration, Distance: float64(s.LengthPool) * float64(s.CountPool) / MInKm, Speed: s.meanSpeed(), Calories: s.Calories()}
	return message
}
